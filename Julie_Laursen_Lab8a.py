...
def gallons_list():
    print('Gallons conversion chart:','\n')
    ...
    gallons_list = [['1, 3.9'],
                    ...
                    ['9, 35.1'],
                    ['10, 39']                  ]
    print(gallons_list[0])
    print(gallons_list[1])
    print(gallons_list[2])
    print(gallons_list[3])
    print(gallons_list[4])
    print(gallons_list[5])
    print(gallons_list[6])
    print(gallons_list[7])
    print(gallons_list[8])
    print(gallons_list[9])

def pounds_list():
    print('Pounds conversion chart:','\n')
    print('Pounds\tLiters')
    print('---------------')
    pounds_list = [['1, .45'],
                    ['2, .9'],
