...
'''
students = [
    { 'name': 'Julie', 'gpa': 4.0, 'id': 23409, 'expectedGrade': 'A', 'ftOrPt': 'Ft'},
    { 'name': 'Same', 'gpa': 1.0, 'id': 32409, 'expectedGrade': 'F', 'ftOrPt': 'Pt'},
]

student_list = []

for student in students:
    student_list.append(student2.Student(student['name'], student['gpa'], student['id'], student['expectedGrade'], student['ftOrPt']))
